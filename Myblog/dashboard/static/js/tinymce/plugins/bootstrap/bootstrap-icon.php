    ...
    <div class="container">
        ...
        <div class="row margin-bottom-md">
            ...
            <div class="text-center">
                <div class="choice selector select-size margin-bottom-md">
                    <p><i class="glyphicon glyphicon-home"></i> extra-small</p>
                </div>
                <div class="choice selector select-size margin-bottom-md">
                    <h4><i class="glyphicon glyphicon-home"></i> small</h4>
                </div>
                <div class="choice selector select-size margin-bottom-md">
                    <h3><i class="glyphicon glyphicon-home"></i> medium</h3>
                </div>
                <div class="choice selector select-size margin-bottom-md">
                    <h2><i class="glyphicon glyphicon-home"></i> large</h2>
                </div>
                <strong>Custom</strong> : <input name="size-input" size="10" value=""> <strong>px</strong>
            </div>
        </div>
        <div class="row margin-bottom-md ">
            <div class="choice-title">
            ...
            <div class="text-center">
                ...
                <div id="colorselector">
                    <label>Custom : </label><div style="background-color: rgb(239, 239, 239);"></div>
                </div>
            </div>
        </div>
        <div class="row" id="preview">
            ...
            <div class="col-sm-12 margin-bottom-md text-center test-icon-wrapper" id="test-wrapper">
                &nbsp;<span class="glyphicon glyphicon-home" id="icon-test"></span>            </div>
        </div>
        <div class="row">
            <div id="code-title">
            ...
            <div class="col-sm-12 text-center" id="code-wrapper">
                <pre>&lt;span class=&quot;glyphicon glyphicon-home&quot; id=&quot;icon-test&quot;&gt;&lt;/span&gt;</pre>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var glyphicon = 'glyphicon-home'; //console.log(glyphicon);
    var iconSize  = ''; // console.log(iconSize);
    var iconColor = ''; //console.log(iconColor);
    var iconCode  = '<span class="glyphicon glyphicon-home" id="icon-test"></span>'; //console.log(iconCode);

...
<body>
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="text-center">
                    <div class="btn-group btn-toggle-position">
                        <button class="btn btn-sm btn-default" data-attr="false">CENTER</button>
                        <button class="btn btn-sm btn-success active" data-attr="true">PUSH TO THE SIDES</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row margin-bottom-md">
            ...
            <div class="col-xs-4"><h4>Link</h4></div>
            <div class="col-xs-4"><h4>Disabled</h4></div>
            <div class="col-xs-12" id="content">
                <div class="row">
                    <div class="col-xs-4">
                        <div class="form-group">
                            <input class="form-control select-text" type="text" value="&larr; Previous">
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <div class="form-group">
                            <input class="form-control select-text" type="text" value="Next &rarr;">
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="form-group">
        ...
        <div class="row" id="preview">
            ...
            <div class="col-sm-12 margin-bottom-md" id="test-wrapper">
                <ul class="pager"><li class="previous"><a href="#">&larr; Previous</a></li> <li class="next"><a href="#">Next &rarr;</a></li></ul>            </div>
        </div>
        <div class="row">
            <div id="code-title">
...
<script type="text/javascript">
    var newPager  = '1';
    var pagerCode  = '<ul class="pager"><li class="previous"><a href="#">&larr; Previous</a></li> <li class="next"><a href="#">Next &rarr;</a></li></ul>';
    var index;
    $(document).ready(function () {
        ...
        function addNewItem(text, link, disabled)
        {
            ...
            if (disabled) {
                newItemHtml += '<div class="col-sm-4"><div class="btn-group btn-toggle"><button class="btn btn-sm btn-default" data-attr="false">NO</button><button class="btn btn-sm btn-success active" data-attr="true">YES</button></div></div></div>'
            } else {
                newItemHtml += '<div class="col-sm-4"><div class="btn-group btn-toggle"><button class="btn btn-sm btn-success active" data-attr="false">NO</button><button class="btn btn-sm btn-default" data-attr="true">YES</button></div></div></div>'
            }

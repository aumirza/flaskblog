...
tinymce.PluginManager.add('bootstrap', function(editor, url) {
    ...
    function showDialog(iframeUrl, iframeTitle, iframeHeight, type)
    {
        ...
        if(jQuery(selectedNode).hasClass('active')) {
            ...
            } else if(jQuery(selectedNode).hasClass('glyphicon')) {
    ...
    function renderContent(element, type)
    {
        ...
        tinymce.activeEditor.dom.remove(tinymce.activeEditor.dom.select('li > br[data-mce-bogus="1"]'));
    }
    ...
    function getNodeAttributes(selectedNode, type)
    {
        ...
        if(type == 'bsBtn') {
            ...
            var glyphicon = jQuery(selectedNode).attr('class').split(' ')[1];
    ...
    function initCallbackEvents()
    {
        ...
        tinymce.activeEditor.on('click keyup', function(e) {
            ...
            if(jQuery(e.target).is('img')) { // image
                ...
                } else if(jQuery(e.target).attr('class').match(/glyphicon/)) {
